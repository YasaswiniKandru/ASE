...
public class InterLandingGenr extends ViewableAtomic{
  ...
  public InterLandingGenr() {this("InterLandingGenr", 10);}

public InterLandingGenr(String name,double period){
   super(name);
   addInport("in");
   addOutport("InterLandingOut");
...
//System.out.println(name+" out count "+count);
   ...
   content con = makeContent("InterLandingOut", new entity("Inter_Landing_" + count));
